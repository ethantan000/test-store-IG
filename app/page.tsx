          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <StaggerItem>
              <div className="text-center">
                ...
                <h3 className="font-display font-bold text-lg mb-2">Secure Payments</h3>
                <p className="text-sm text-white/50">Your payment information is encrypted and secure. We accept all major cards.</p>
              </div>
            </StaggerItem>
          </StaggerContainer>
        </div>
      ...
      <FadeInView>
        <section className="py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="card-glow p-12 lg:p-16 rounded-3xl bg-gradient-hero relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-white/60 max-w-xl mx-auto mb-8">
                  Join thousands of happy customers who found their favorite products through ViralGoods.
                </p>
